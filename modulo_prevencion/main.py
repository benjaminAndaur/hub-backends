...
from src.controller.incidente_controller import create_incidente_blueprint
...
async def inject_dependencies():
    ...
    repo = IncidenteRepository(session)
    service = IncidenteService(repo)
...
# Registrar blueprint
bp = create_incidente_blueprint()

app.register_blueprint(bp, url_prefix='/api/v1/prevencion')
